...
* **Especificación‑como‑código:** PRD/ADR en Markdown, trazabilidad a código y tests.
...
* Programación en Javascript, Python. otro lenguaje de programacion moderno.  
...
* Suscripción a Claude Pro ($20 USD)

## **Tu producto**

Trae el problema a resolver o la idea, si no tienes puedes elegir una del banco de proyectos que te ofreceremos. El reto para ti será convertir ese problema/idea en un producto a lo largo del mes. Importante que tengas acceso al usuario o cliente para validar a lo largo del mes.
...
Para el demo day, tendrás que cargar el día anterior un video de 3 minutos con la demostración de tu producto. Seleccionaremos algunos para ser presentados en vivo durante la sesión con founders invitados.
...
Perfil Linkedin: https://www.linkedin.com/in/leonardo-gonzalez-technology/

Danny Bravo. AI Product Innovator y cofundador de Tribu iA.
Perfil de Linkedin: https://www.linkedin.com/in/dannybravo1/

Carlos Alarcón. Co-founder y CTO de Quix - ex Platzi. Youtuber y GDE
Perfil de Linkedin: https://www.linkedin.com/in/alarcon7a/

Christian Braatz. Arquitecto de Software con 20 años de experiencia.
Perfil de Linkedin: https://www.linkedin.com/in/christian-braatz/
...
Puedes pagar con tarjeta de crédito o transferencia bancaria.
...
Semana de nivelación: Febrero 23
Inicio de clases: Marzo 2
